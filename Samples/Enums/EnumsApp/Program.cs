...
// Strategy 1: Use a collection of enums
...
// Strategy 3: Use a many to many (v2)
...
//    {
//        Titre = "Titre1",
//        Categories = new List<Categorie>() { new() { CategorieId = (int) Category.Aventure } },
//    };
